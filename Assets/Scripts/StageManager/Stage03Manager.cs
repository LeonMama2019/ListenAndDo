...
public class Stage03Manager : MonoBehaviour
{
    ...
    [SerializeField] private AnswerStage03 stage03Answer;

    [Header("Pick選択後、問題を開始するまでの待ち時間")]
    ...
    private void Start()
    {
        // Stage03はPick選択チュートリアル完了まで問題を開始しない。
    }

    public void StartQuestionsAfterPickSelected()
    {
    ...
    public void ShowNextQuestion()
    {
        ...
        {
            Debug.LogWarning("Stage03Manager: StageDataに問題がありません");
            return;
        }
        ...
        if (stage03Answer != null) stage03Answer.SetTask(currentTask);
        speakerClickCount = 0;
    ...
    public void PlayCurrentVoice()
    {
        ...
        {
            Debug.LogWarning("Stage03Manager: 問題音声を再生できません");
            return;
        }
