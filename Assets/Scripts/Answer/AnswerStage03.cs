...
public class AnswerStage03 : MonoBehaviour
{
    [Header("判定したいオブジェクト")]
    ...
    [SerializeField] private Stage03Manager stage03Manager;
    ...
    private IEnumerator NextQuestionCoroutine()
    {
        ...
        if (completedQuestions >= totalQuestions)
        {
            ...
            {
                Debug.LogWarning("AnswerStage03: TutorialFinishPanelが設定されていません");
                LoadTopScene();
            }
            yield break;
        }
        ...
        if (stage03Manager != null) stage03Manager.ShowNextQuestion();
        else Debug.LogWarning("AnswerStage03: Stage03Managerが設定されていません");
    }
