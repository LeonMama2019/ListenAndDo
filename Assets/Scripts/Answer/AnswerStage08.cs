...
public class AnswerStage08 : MonoBehaviour
{
    [Header("判定したいオブジェクト")]
    ...
    [SerializeField] private Stage08Manager stage08Manager;
    ...
    private GameObject previousMouseOverObject;
    private float questionStartTime;
    private int attemptNumber;
    private int completedQuestions;
    private bool finishPanelActive;
    ...
    private IEnumerator NextQuestionCoroutine()
    {
        ...
        if (stage08Manager != null) stage08Manager.ShowNextQuestion();
        else Debug.LogWarning("AnswerStage08: Stage08Managerが設定されていません");
    }
